...
6. In the wizard 
   ...
   - In 'Export Location' select " a path e.g. 'C:\temp\ESNPJ\esnpj.jar' 
...
7. Copy the content of the projects sub-folder scripts into the export location 
   folder 'C:\temp\ESNPJ\'. The files copied are script files, tsm.bat and tsm.sh, 
...
9. On Unix make the script file esnpj.sh you just copied executable
10. If, in step 6, you picked 2. 'Copy required libraries into a sub folder next to the generated JAR',
    delete the folder 'C:\temp\ESNPJ\esnpj_lib', if you want to control which PlainJava Client Libraries folder 
    to use in the esnpj.bat/esnpj.sh launch script. You can provide the Plain Java Client Libraries folder or use 
    the exported library files 

The application is now usable. 

To ship it 
1. Select the folder 'C:\temp\ESNPJ\' and compress the file
2. Rename the archive file to esnpj-Vx-YYYYMMDD.zip, 
